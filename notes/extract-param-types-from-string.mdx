---
title: extract param types from string literal 
published: true
listed: true
date: '08/03/2022'
tags: typescript
...
based on [this blog post](https://lihautan.com/extract-parameters-type-from-string-literal-types-with-typescript/)
